 ...
 * @author omaneesshh
 */
@WebServlet(urlPatterns = {"/change_password_admin"})
public class change_password_admin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           String a="",b="";
            ...
            a=hs.getAttribute("adminname").toString();
           try
           {
               ...
               String x="select * from admin where uname='"+a+"'";
               ...
               String x1="update admin set pass='"+newp+"' where uname='"+a+"'";
               stmt1.execute(x1);
               response.sendRedirect("change_pass_admin.jsp");}
                   else
                   {

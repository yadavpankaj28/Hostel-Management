...
<html>
    ...
    <body>
        ...
        try
           {
               ...
               String x="select * from warden_notice where id='"+notice+"'";
      ...
      %>
      <form action="warden_notice_update" method="post">
            Enter Notice <textarea  name="not" rows="5" cols="60"  style="resize: none"><%=noti%></textarea>
    <br><br>

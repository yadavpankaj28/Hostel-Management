<%-- 
    Document   : warden_header
    Created on : Nov 16, 2017, 1:22:20 AM
    Author     : omaneesshh
--%>
			...
			<div class="container">
				<div class="navbar-header">
					<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
					  ...
					  <a href="wardenhome.jsp" class="navbar-brand  data-scroll"><img src="images/a.png" height="50px" alt=""><span></span></a>
				</div>

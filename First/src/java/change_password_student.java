 ...
 * @author omaneesshh
 */
@WebServlet(urlPatterns = {"/change_password_student"})
public class change_password_student extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           String a="",b="";
            ...
            a=hs.getAttribute("sturoll").toString();
           try
           {
               ...
               String x="select * from student_reg where rollno="+a+"";
               ...
               String x1="update student_reg set password='"+newp+"' where rollno="+a+"";
               stmt1.execute(x1);
               response.sendRedirect("change_password_stu.jsp");}
                   else
                   {
